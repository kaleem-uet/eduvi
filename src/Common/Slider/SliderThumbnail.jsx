...
import { ImageWrapper, TumbnailImage } from './StyledComponents/SliderCustomComponents';

function SliderThumbnail({ activeRef, disabledRef, setActiveSlide, activeSlide, items }) {
    return (
            ...
            {items.map((item, i) => (
                <Paper
                    ...
                    sx={(theme) => ({
                        ...
                        marginY: '1rem',
                        backgroundColor:
                            activeSlide == i ? theme.palette.background.paper : theme.palette.action.disabledBackground,
                    })}
                >
                    <Box display="flex" justifyContent="flex-start">
                        <TumbnailImage>
                            <ImageWrapper size="cover" backgroundImage={item.src} backgroundColor={true} />
                        </TumbnailImage>
                        <Box padding=".5rem">
